...
Source0  : https://cran.r-project.org/src/contrib/tidyselect_1.1.1.tar.gz
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1619793574
...
/usr/lib64/R/library/tidyselect/tests/testthat/outputs/eval-sym-verbosity.txt
...
/usr/lib64/R/library/tidyselect/tests/testthat/outputs/test-helpers-where.txt

...
Version  : 0.2.2
Release  : 1
URL      : https://cran.r-project.org/src/contrib/tidyselect_0.2.2.tar.gz
Source0  : https://cran.r-project.org/src/contrib/tidyselect_0.2.2.tar.gz
...
export LANG=C
export SOURCE_DATE_EPOCH=1509124803

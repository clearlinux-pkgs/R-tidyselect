...
Version  : 1.1.2
Release  : 46
URL      : https://cran.r-project.org/src/contrib/tidyselect_1.1.2.tar.gz
Source0  : https://cran.r-project.org/src/contrib/tidyselect_1.1.2.tar.gz
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1645552517
...
/usr/lib64/R/library/tidyselect/tests/testthat/_snaps/rename.md
/usr/lib64/R/library/tidyselect/tests/testthat/_snaps/select.md
